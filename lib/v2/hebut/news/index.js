...
const news_base_url = 'https://xww.hebut.edu.cn/';
const repo_url = 'https://github.com/nobodynone/rssbhl/issues';
...
const pageType = (href) => {
    ...
    if (url.hostname === 'xww.hebut.edu.cn') {
        return 'hebut-news';
    } else {
        return 'unknown';
    }
